...
def main():
    ...
    with col1:
        ...
        placeholders = {
            ...
            "\\textless{} \\textbf{Referrer's Name} \\textgreater{}": "Enter the name of the Referrer: ",
            "\\textless{} \\textbf{Referrer's Address} \\textgreater{}": "Enter the address of the referrer: ",
            "\\textless{} \\textbf{Seller's Name} \\textgreater{}": "Enter the seller's name: ",
            "\textless{} \textbf{Seller's Address} \textgreater{}": "Enter the seller's address: ",
            "\textless{} \textbf{Business Type} \textgreater{}": "Enter the business type: ",
            "\\textbf{Name of the person  in contact} \\textgreater{}": "Enter the name of the person in contact: ",
            "\\textless{} \\textbf{End Date} \\textgreater{}": "Enter the end date: ",
            "\\textless{} \\textbf{No of days} \\textgreater{}": "Enter theno of days: ",
            "\\textless{} \\textbf{Commission Amount} \\textgreater{}": "Enter the commision amount: ",
            "\\textless{} \\textbf{Invoice Frequency} \\textgreater{}": "Enter the invoive frequency: ",
            "\\textless{} \\textbf{Payment Method} \\textgreater{}": "Enter the payment method: ",
            "\\textless{} \\textbf{Confidentiality Duration} \\textgreater{}": "Enter the confidentiality duration: ",
        }
        ...
        if uploaded_file:
            uploaded_file2 = ""  # Path to your image
        if uploaded_file2:
        ...
        if st.button('Finalize Document') and all(responses.values()):
            update_document('/Users/akshatmanohar/Downloads/Nlp latex/vertopal.com_Referral-Agreement-Template-Signaturely.latex', responses)
            st.success("Document updated successfully!")
