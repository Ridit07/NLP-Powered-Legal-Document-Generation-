...
def main():
    ...
    with col1:
        ...
        placeholders = {
            ...
            "\\textbf{\\textless Effective Date\\textgreater{}} (the \\textbf{``Effective Date''})": "Enter the effective date of the agreement (e.g., 2024-04-26): ",
            "\\textless{}\\textbf{Indemnifying Party\\textquotesingle s Name\\textgreater,}": "Enter the name of the Indemnifying Party: ",
            "\\textless{}\textbf{Indemnifying Party\\textquotesingle Address}\\textgreater{}": "Enter the Indemnifying Party's address: ",
            "\textless{}\\textbf{Indemnified Party\\textquotesingle s Name\\textgreater,}": "Enter the name of the Indemnified Party: ",
            "\\textbf{\\textless Indemnified Party\\textquotesingle s Address\\textgreater{} (}": "Enter the Indemnified Party's address: ",
            "\\textbf{\\textless Governing Law\\textgreater.}": "Enter the governing law (e.g., the state or country): ",
            "\\textbf{\\textless Arbitration/mediation/negotiation\\textgreater{}}": "Enter the method for dispute resolution (e.g., arbitration, mediation): ",
            "\\textless{}\\textbf{Indemnified party signature\\textgreater{}}": "Enter the placeholder for the Indemnified party signature: ",
            "\\textless{}\\textbf{Indemnifying Party Name}\\textgreater{}": "Enter the placeholder for the Indemnifying Party signature: ",
            "\\textless{}\\textbf{Date\\textgreater{}}": "Enter the date of signing: "
        }
        ...
        # Multiple checkboxes
        options = st.checkbox("Options", ["Option A", "Option B", "Option C"])
    
        # Using a dictionary to associate values with checkboxes
        options_dict = {
            "Option X": False,
            "Option Y": False,
            "Option Z": False
        }
        options_updated = st.checkbox("Options (Dict)", options_dict.keys())
        ...
        if st.button('Finalize Document') and all(responses.values()):
            update_document('/Users/riditjain/Desktop/Nlp latex/vertopal.com_Indemnification-Agreement-Template-Signaturely.latex', responses)
            st.success("Document updated successfully!")
