...
def main():
    ...
    with col1:
        ...
        if uploaded_file:
            uploaded_file2 = "g"  # Path to your image
        if uploaded_file2:
        ...
        if st.button('Finalize Document') and all(responses.values()):
            update_document('/Users/riditjain/Desktop/Nlp latex/vertopal.com_Sales-Contract-Template-Signaturely (1) (1).latex', responses)
            st.success("Document updated successfully!")
    ...
    #     st.markdown(pdf_display, unsafe_allow_html=True)
        ...
        pdf_path = "/Users/riditjain/Downloads/PlushCV__2021_25_ (3).pdf"  # Specify the path to the PDF file here
        with open(pdf_path, "rb") as pdf_file:
            base64_pdf = base64.b64encode(pdf_file.read()).decode('utf-8')
